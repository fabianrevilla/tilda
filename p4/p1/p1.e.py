...
## IN
##
## OUT Returnerar en dictionary med info om vilken version som ska uppdateras och vilken version av programmet som ska kollas
##
...
## search_data
##
## IN What är det som ska sökas efter i schemat. Indata från parse_command_line_args()
##
## OUT
##
